...
namespace Panzers.AI
{
    ...
    public class ThereIsEnemyUnitInMyTowerRangeAndIHaveUnitOnItRange : ConditionActionBase
    {
            ...
            IUtilityMatchQueries queryMatchUtility)
        {
            ...
            var myNearestUnitToEnemy =
                GetMyNearestUnitToSelectedEnemy(matchState, generalMatchUtility, enemyNearMyTower);
            FieldCoordinate destination = generalMatchUtility.MoveToDestination(
                myNearestUnitToEnemy.CurrentState.MovingUnitsInTurn.Data, myNearestUnitToEnemy.FieldCoordinate.Data,
        ...
        private static FightingUnitMonoBase GetEnemyNearMyTower(MatchModel matchState,
            IUtilityMatchGeneral generalMatchUtility)
        {
