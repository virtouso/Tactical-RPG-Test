...
{
    [CreateAssetMenu(fileName = "ThereIsEnemyUnitInMyTowerRangeAndHaveNoUnitOnItRange",
        menuName = "Config/Condition Action/ThereIsEnemyUnitInMyTowerRangeAndHaveNoUnitOnItRange")]
    public class ThereIsEnemyUnitInMyTowerRangeAndHaveNoUnitOnItRange : ConditionActionBase
    {
            ...
            IUtilityMatchQueries queryMatchUtility)
        {
            ...
            {
                if (generalMatchUtility.CalculateDistanceBetween2Coordinates(item.FieldCoordinate.Data,
                    nearPlayerUnitToMyTower.FieldCoordinate.Data) < item.CurrentState.MovingUnitsInTurn.Data)
                {
