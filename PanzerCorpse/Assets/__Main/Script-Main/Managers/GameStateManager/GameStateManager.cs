...
namespace Panzers.Manager
{
    public class GameStateManager : MonoBehaviour, IGameStateManager
    {
        ...
        private IEnumerator UpdateTurn(bool isInitial)
        {
            ...
            else
            {
                ...
                if (_matchQueryUtility.MatchModel.Players[currentTurn].CurrentPermittedMoves <= 0)
                {
                    ...
                    _matchQueryUtility.MatchModel.Players[_matchQueryUtility.MatchModel.Turn.Data]
                            .CurrentPermittedMoves =
                        _matchQueryUtility.MatchModel.NumberOfPermittedMovesInOneTurn;
                }
        ...
        public void SelectedWholeMoveByPlayers(ActionQuery actionQuery)
        {
            ...
            _logger.ShowNormalLog("Action Is valid::" + moveIsValid + ",from:" + actionQuery.From, Color.green,
                Channels.MatchState);
            ClearBoardColors();
            if (!moveIsValid)
            {
